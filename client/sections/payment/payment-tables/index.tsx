...
import { GENDER_OPTIONS, useDocumentTableFilters } from './use-document-table-filters';

export default function PaymentTable({ data, totalData }: { data: Payment[]; totalData: number }) {
